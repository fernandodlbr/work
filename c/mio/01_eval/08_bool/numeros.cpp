...
int main(int argc, char *argv[]){
  ...
  cantidad_de_terminos = atoi(argv[1]);
  ...
  for(int cantidad_de_terminos_calculados = 2;
      cantidad_de_terminos_calculados < cantidad_de_terminos;
  ...
  for(int cantidad_de_terminos_impresos = 0;
      cantidad_de_terminos_impresos < cantidad_de_terminos;
